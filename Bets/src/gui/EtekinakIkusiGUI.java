...
public class EtekinakIkusiGUI extends JFrame {
	...
	private void jbInit() throws Exception
	{
		...
		jLabelQueries.setBounds(52, 261, 68, 14);
...
this.getContentPane().add(scrollPaneEvents, null);
		...
		JButton btnEtekinakIkusi = new JButton(ResourceBundle.getBundle("Etiquetas").getString("EtekinakIkusiGUI.btnEtekinakIkusi.text")); //$NON-NLS-1$ //$NON-NLS-2$
		btnEtekinakIkusi.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				try {
					...
					for(int a=0; a<g.getKuotak().size();a++) {
						etekinaG=etekinaG+g.getKuotak().get(a).getLortutakoEtekina();
						aux=aux + g.getKuotak().get(a).toString() + "\n";
						
						comboBox.addItem(g.getKuotak().get(a).toStringEtekina());
					}
		...
		btnEtekinakIkusi.setBounds(509, 226, 133, 25);
		getContentPane().add(btnEtekinakIkusi);
